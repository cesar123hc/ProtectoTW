...
public class BuscarSaludosResponse {
    ...
    protected List<BuscarSaludosResponse.Historial> historial;
     ...
     * {@link BuscarSaludosResponse.Historial }
     * 
     * 
     */
    public List<BuscarSaludosResponse.Historial> getHistorial() {
        if (historial == null) {
            historial = new ArrayList<BuscarSaludosResponse.Historial>();
        }
